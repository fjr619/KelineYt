...
import com.example.kelineyt.databinding.ItemBillingProductsBinding
...
class BillingProductsAdapter: Adapter<BillingProductsAdapter.BillingProductsViewHolder>() {
    ...
    inner class BillingProductsViewHolder(val binding: ItemBillingProductsBinding): ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BillingProductsViewHolder {
        return BillingProductsViewHolder(
            ItemBillingProductsBinding.inflate(
