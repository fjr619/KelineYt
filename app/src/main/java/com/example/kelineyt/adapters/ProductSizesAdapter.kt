...
import com.example.kelineyt.databinding.ItemProductSizesBinding

class ProductSizesAdapter : RecyclerView.Adapter<ProductSizesAdapter.SizesViewHolder>() {

    private var selectedPosition = -1

    inner class SizesViewHolder(private val binding: ItemProductSizesBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SizesViewHolder {
        return SizesViewHolder(
            ItemProductSizesBinding.inflate(
